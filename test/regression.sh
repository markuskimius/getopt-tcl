...
proc main { argv } {
    ...
    test -n --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1
    test --no-arg -nwwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1
    test --no-arg -wwarg1 -nw warg2 --with-arg warg3 --with-arg=warg4 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -ni1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 -ni 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1 -n
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 -n myarg1
    test --no-arg -w warg1 --with-arg warg2 --with-arg=warg3 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1 -nwwarg4
    test --no-arg -w warg1 --with-arg warg2 --with-arg=warg3 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 -nwwarg4 myarg1
    test --no-arg -wwarg1 --with-arg warg2 --with-arg=warg3 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1 -nw warg4
    test --no-arg -wwarg1 --with-arg warg2 --with-arg=warg3 -i1024 -i 2048 --integer 3072 --integer=4096 -o 32 -o64 --opt-arg 128 --opt-arg=256 -nw warg4 myarg1
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i 1024 --integer 2048 --integer=3072 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1 -ni4096
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i 1024 --integer 2048 --integer=3072 -o 32 -o64 --opt-arg 128 --opt-arg=256 -ni4096 myarg1
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 --integer 2048 --integer=3072 -o 32 -o64 --opt-arg 128 --opt-arg=256 myarg1 -ni 4096
    test --no-arg -wwarg1 -w warg2 --with-arg warg3 --with-arg=warg4 -i1024 --integer 2048 --integer=3072 -o 32 -o64 --opt-arg 128 --opt-arg=256 -ni 4096 myarg1
    ...
    test -n --no-arg -wwarg1 -w "" -o warg2 -owarg3 -i1024 -i 2048 --integer 3072 --integer=4096 myarg1
    test -n --no-arg -wwarg1 -w warg2 -o "" -owarg3 -i1024 -i 2048 --integer 3072 --integer=4096 myarg1
    test -n --no-arg -wwarg1 -w warg2 -o warg3 -o "" -i1024 -i 2048 --integer 3072 --integer=4096 myarg1
    test -n --no-arg -wwarg1 -w warg2 -o warg3 -i1024 -i 1024 --integer 2048 --integer=3072 myarg1 -o ""
    test -n --no-arg -wwarg1 -w warg2 -o warg3 -i1024 -i 1024 --integer 2048 --integer=3072 -o "" myarg1
...
proc target { args } {
    ...
    while { 1 } {
        set c [getopt $args "n 0 no-arg 0 w 1 with-arg 1 i is_int integer is_int o (is_int,null) opt-arg (is_int,null)"]
        if { $c == -1 } break
